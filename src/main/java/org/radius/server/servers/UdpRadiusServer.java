...
import org.radius.server.DuplicationStrategy;
import org.radius.server.RadiusServer;
import org.radius.server.TimedDuplicationStrategy;
...
public class UdpRadiusServer implements RadiusServer {
    ...
    private final static class SelectorManager extends Thread {
        ...
        private void runHandler(InetSocketAddress clientAddress, ByteBuffer inByteBuffer) throws Exception {
            ...
            if (secret != null) {
                ...
                DuplicationStrategy.Result result = udpRadiusServer.duplicationStrategy.handleRequest(clientAddress, requestPacket);
